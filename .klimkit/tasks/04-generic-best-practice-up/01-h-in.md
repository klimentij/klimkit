add these rules to main agents.md in pack (except token budget). not just insert them, but carefully integrate, avoiding confusion and duplication. also analayze against all skills subagetns etc in pack . these knowledge must be naturally carefully integrated into the pack:
...
also integrate these instructions: ![alt text](image.png)

===

then deeply analayze this https://github.com/mattpocock/skills and compare to klimkit. propose up to 10 things to take directly or as inpiration to klimkit
