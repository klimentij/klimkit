...
- [ ] The researcher inspects local OpenAI Symphony at `/home/ubuntu/symphony`, records the inspected branch/commit/status when discoverable, and reads enough of its README/spec/workflow/skills/implementation files to ground the comparison.
