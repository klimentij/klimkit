---
name: agent-browser
description: Browser automation CLI for AI agents. Use for websites, local web apps, forms, clicks, screenshots, scraping, QA, and exploratory testing. Also applies to Electron app automation, Slack checks, cloud browsers, and local browser tasks.
