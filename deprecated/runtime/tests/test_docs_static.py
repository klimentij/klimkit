...
class DocsStaticTests(unittest.TestCase):
    def test_readme_has_product_first_sections(self) -> None:
        ...
        self.assertIn("public Codex plugin", first_paragraph)
        ...
        self.assertIn("The default operating promise is plugin-first Codex work", text)
        self.assertIn("## Advanced Repo-Managed Install", text)
        self.assertIn("codex plugin marketplace add klimentij/klimkit --ref main", text)
        self.assertIn("codex plugin add klimkit@klimkit", text)
        self.assertIn("codex plugin marketplace upgrade klimkit", text)
        self.assertIn("The Codex app is the recommended day-to-day surface", text)
        self.assertIn("Switchboard is no longer the default Klimkit entry point", text)
        self.assertIn("## Codex Harness Workflow", text)
        self.assertIn("## Codex Plugin And Harness Pack", text)
